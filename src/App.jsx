  ...
  return (
    <div className="App">
      ...
      <div className='intro'> <TypeAnimation
        sequence={[
          ' الى كل من غلبهم الشوق و ملأتهم الأمنيات بزيارة بيت الله الحرام ومسجد رسول اللّه ﷺ، تعلن شركة الماسة ترافيل عن فتح باب حجز العمرة لموسم 1445 من الهجرة النبوية الشريفة سائلين اللّه لنا ولكم القبول والاخلاص',
          9999999999999999,
          "",
        ]}
        speed={30}
